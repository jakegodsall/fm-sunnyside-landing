    ...
    return (
        <ul className="flex gap-[2rem]">
            <li>
                <a href="#">
                    <svg
                        className="h-[2rem] w-[2rem] fill-current text-[#2c7566] transition-all duration-100 hover:text-white"
            ...
            <li>
                <a href="#">
                    <svg
                        className="h-[1.7rem] w-[2rem] fill-current text-[#2c7566] transition-all duration-100 hover:text-white"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
